...
RUN php-backport /flux-ilias-rest-legacy-cron-helper-plugin FluxIliasRestApi\\Libs\\FluxLegacyEnum
...
COPY --from=build /flux-ilias-rest-legacy-cron-helper-plugin /flux-ilias-rest-legacy-cron-helper-plugin
